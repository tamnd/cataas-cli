...
Most of these come down to network reality or how cataas serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cataas rate-limits like any public site. cataas already paces
...
Where a surface is gated, cataas reads a cookie or token you supply
...
`cataas`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cataas actually did
