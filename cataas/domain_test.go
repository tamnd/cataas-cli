...
// HTTP behaviour is covered in cataas_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "cataas://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("cataas", "about")
	if err != nil || got.String() != "cataas://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want cataas://page/about", got.String(), err)
	}
}
